...
def inference(images, **kwargs): #batchSize=None, phase='train', outLayer=[13,13], existingParams=[]
    ...
    fireOut, prevExpandDim = conv_fire_module('conv1', images, kwargs.get('imageChannels'),
                                              {'cnn3x3': modelShape[0]},
                                              wd, **kwargs)
    ...
    fireOut, prevExpandDim = conv_fire_module('conv2', fireOut, prevExpandDim,
                                              {'cnn3x3': modelShape[1]},
                                              wd, **kwargs)
    ...
    fireOut, prevExpandDim = conv_fire_module('conv3', pool, prevExpandDim,
                                              {'cnn3x3': modelShape[2]},
                                              wd, **kwargs)
    ...
    fireOut, prevExpandDim = conv_fire_module('conv4', fireOut, prevExpandDim,
                                              {'cnn3x3': modelShape[3]},
                                              wd, **kwargs)
