...
trainLogDir = trainLogDirBase+'170116_momentumOpt'
testLogDir = testLogDirBase+'170116_momentumOpt'
imageSize = 128
imageChannels = 2
outputSize = 8
modelShape = [64, 64, 64, 64, 128, 128, 128, 128]
...
##############
if False:
    write_json_file('170116_momentumOpt.json', data)
...
if False:
    ...
    data['numEpochsPerDecay'] = 30000
    data['trainBatchSize'] = 16
    data['testBatchSize'] = 16
    data['testMaxSteps'] = int(np.ceil(data['numTestDatasetExamples']/data['testBatchSize']))
    data['modelShape'] = [64, 64, 64, 64, 128, 128, 256, 256]
...
if False:
    ...
    data['testBatchSize'] = 20
    data['testMaxSteps'] = int(np.ceil(data['numTestDatasetExamples']/data['testBatchSize']))
    data['modelShape'] = [64, 64, 64, 64, 256, 256, 256, 256]
    data['batchNorm'] = False
    data['weightNorm'] = True
